...
/// <summary>National Dex species #001–#150 (Bulbasaur through Mewtwo) for a 10×15 grid.</summary>
public static class PokedexKantoOneFifty
{
    ...
    public static readonly Dictionary<string, int> CellIndexBySpeciesName =
        SpeciesNames.Select((name, i) => (name, i)).ToDictionary(t => t.name, t => t.i, StringComparer.Ordinal);
